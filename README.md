...
Projeto para a implementação de testes de componentes predefinidos, utilizando React Testing Library, desenvolvido durante o curso de desenvolvimento de software na [Trybe](https://www.betrybe.com/).
